...
urlpatterns = [
    ...
    path('hobt_search/', views.hobt_search, name='hobt_search'), # 검색기능
    path('cs_search/', views.cs_search, name='cs_search'), # 검색기능
    path('adsp_search/', views.adsp_search, name='adsp_search'), # 검색기능
    ...
    path('cs_dict/', views.cs_dict, name='cs_dict'),
    path('adsp_dict/', views.adsp_dict, name='adsp_dict'),
]